...
public class ElevatorConstants {
    ...
    public static class ElevatorConstantsRobot {
        public static final double ROBOT_GEAR_RADIUS = 0.03;
        public static final double ROBOT_GEAR_CIRCUMFERENCE = 2 * Math.PI * ROBOT_GEAR_RADIUS;

        public static double ROBOT_ROTATIONS_TO_LENGTH(double rotations) {
            return (rotations / GEAR_RATIO) * ROBOT_GEAR_CIRCUMFERENCE;
        }

        public static double ROBOT_LENGTH_TO_ROTATIONS(double length) {
            return (length / ROBOT_GEAR_CIRCUMFERENCE) * GEAR_RATIO;
        }
    }

    public static class ElevatorConstantsSimulation {
